#ifndef mulle_objc_unicode_foundation_include_h__
#define mulle_objc_unicode_foundation_include_h__
...
/* This is a central include file to keep dependencies out of the library
   ...
   not "MulleObjCUnicodeFoundation-include.h" to keep the #include statements in the
...
#if defined( MULLE_OBJC_UNICODE_FOUNDATION_BUILD) || defined( MULLE_FOUNDATION_BASE_BUILD)
# define MULLE_OBJC_UNICODE_FOUNDATION_GLOBAL    MULLE_C_GLOBAL
#else
# if defined( MULLE_OBJC_UNICODE_FOUNDATION_INCLUDE_DYNAMIC) || (defined( MULLE_INCLUDE_DYNAMIC) && ! defined( MULLE_OBJC_UNICODE_FOUNDATION_INCLUDE_STATIC))
#  define MULLE_OBJC_UNICODE_FOUNDATION_GLOBAL   MULLE_C_EXTERN_GLOBAL
# else
#  define MULLE_OBJC_UNICODE_FOUNDATION_GLOBAL   extern
# endif
#endif
